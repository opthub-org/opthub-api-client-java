...
public class MatchTrialResponse {
  ...
  public MatchTrialResponse trialNo(@javax.annotation.Nonnull Integer trialNo) {
  ...
  public void setTrialNo(@javax.annotation.Nonnull Integer trialNo) {
    this.trialNo = trialNo;
  }


  public MatchTrialResponse status(@javax.annotation.Nonnull MatchTrialStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@javax.annotation.Nonnull MatchTrialStatus status) {
    this.status = status;
  }


  public MatchTrialResponse createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("trialNo", "status", "createdAt"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("trialNo", "status", "createdAt"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MatchTrialResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MatchTrialResponse is not found in the empty JSON string", MatchTrialResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MatchTrialResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MatchTrialResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
