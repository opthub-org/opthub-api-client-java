...
public class Solution {
  ...
  public Solution variable(@javax.annotation.Nullable ScalarOrVector variable) {
  ...
  public void setVariable(@javax.annotation.Nullable ScalarOrVector variable) {
    this.variable = variable;
  }


  public Solution createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(variable, createdAt);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("variable", "createdAt"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("createdAt"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Solution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Solution is not found in the empty JSON string", Solution.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Solution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Solution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
