...
public class CreateMatchTrialRequest {
  ...
  public CreateMatchTrialRequest variable(@javax.annotation.Nullable ScalarOrVector variable) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("variable"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMatchTrialRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateMatchTrialRequest is not found in the empty JSON string", CreateMatchTrialRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMatchTrialRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateMatchTrialRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
