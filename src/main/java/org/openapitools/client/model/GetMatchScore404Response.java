...
public class GetMatchScore404Response {
  ...
  public GetMatchScore404Response code(@javax.annotation.Nullable CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  public GetMatchScore404Response message(@javax.annotation.Nullable String message) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMatchScore404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetMatchScore404Response is not found in the empty JSON string", GetMatchScore404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMatchScore404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetMatchScore404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
