...
public class ApiClient {
    ...
    protected String basePath = "https://api.competition.opthub.ai";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.competition.opthub.ai",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.competition.opthub.ai)
